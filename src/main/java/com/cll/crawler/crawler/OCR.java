...
public class OCR {
    ...
    private List<BufferedImage> cutPic(BufferedImage img) {
    ...
    private BufferedImage cutPic1(BufferedImage img) {
     ...
     */
    private int identifyColor(int colorId) {
     ...
     * @return 0-1二维数组
     */
    private int[][] binaryZation(BufferedImage img) {
        int w = img.getWidth();
        int h = img.getHeight();
     ...
     */
    public String getCode(InputStream in) throws IOException {
     ...
     */
    public String getCode(String file) throws IOException {
     ...
     * @return 识别的字符
     */
    private String identify1(int[][] binaryPic) {
        //w=33
     ...
     * @return 识别的字符
     */
    private String identify2(int[][] binaryPic) {
        //w=36
        int h = binaryPic.length;
        int count = 0;
        for (int i = 8; i < 38; i++) {
     ...
     * @return 识别的字符
     */
    private String identify3(int[][] binaryPic) {
        //w=36
        int h = binaryPic.length;
        int up = 0;
        int down = 0;
     ...
     * @return 识别的字符
     */
    private String identify4(int[][] binaryPic) {
        //w=33
        int h = binaryPic.length;
        int count = 0;
